...
public class ClienteDireccion2Bean implements Serializable {
	...
	*/
	...
	public void init() {
		...
		// con su dirección  List<Cliente> listarTodosClientes();
		setlistaCliente(clienteService.listarTodosClientes()); //Le quité el null
	...
	public void registrar() {
		...
		setlistaCliente(clienteService.listarTodosClientes()); //Le quite el nulll
		// setlistaCliente(clienteService.findAllClientes());
		getlistaCliente();
	...
	public void onRowEdit(RowEditEvent event) {
		...
		clienteService.cambiarClientePorId(cli, cli.getId());
